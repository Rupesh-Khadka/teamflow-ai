          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  The AI-driven hub for smarter communication.
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  TeamFlowAI organizes discussions into channels with threads,
                  operates in real time, and uses AI to keep teams aligned.
                </TextEffect>
